...
<title>Accounting Firm Funding | BizCashAndCapital — Tailored Financing for CPAs & Accountants</title>
<meta name="description" content="BizCashAndCapital provides specialized funding solutions for accounting firms — Working Capital Loans, Business Expansion, Technology Financing, M&A Financing, Tax Season Loans, and more. Fuel your firm's growth.">
...
<section class="hero-pattern relative overflow-hidden min-h-[55vh] flex items-center justify-center pt-16">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-20 w-full text-center">
    <div class="inline-flex items-center gap-2 bg-white/5 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-white/10">
      ...
      <span class="text-[11px] font-medium tracking-[0.1em] uppercase text-white/70">CPA & Accounting Firm Financing</span>
    </div>
    ...
    <p class="text-white/50 text-base max-w-2xl mx-auto mt-6 font-light">Tailored financing solutions for accounting practices — empowering you to enhance services, expand your client base, and fuel business growth.</p>
  </div>
    ...
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-lime/10 via-lime/5 to-transparent border border-lime/20 p-6 md:p-8 mt-6">
      ...
      <div class="flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
        <div>
          ...
          <h2 class="font-display text-2xl md:text-3xl font-bold text-white">The Importance of Funding for Accounting Firms</h2>
          <p class="text-white/60 text-sm mt-2 max-w-xl">Whether you're a small boutique firm or a larger established practice, strategic funding can be a game-changer. It enables investment in advanced technologies, talent acquisition, and expanded service offerings.</p>
        </div>
...
<div id="funding-options" class="max-w-7xl mx-auto px-6 py-16">
  <div class="text-center mb-12 reveal">
    ...
    <h2 class="font-display text-4xl md:text-5xl text-white mb-3 lime-underline">Accounting Firm Funding Options</h2>
    <p class="text-white/40 text-[15px] mt-6 leading-relaxed max-w-2xl mx-auto">We offer a range of funding options customized to meet the unique needs of accounting firms.</p>
  </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <div class="group relative rounded-2xl overflow-hidden bg-ink border border-white/10 hover:border-lime/40 transition-all duration-500 hover:-translate-y-2">
      ...
      <div class="relative z-10 p-6 min-h-[340px] flex flex-col">
        <div class="icon-circle mb-4 bg-lime/20 backdrop-blur-sm border border-lime/30">
          <svg class="w-7 h-7 text-lime" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>
        </div>
...
<div id="contact" class="max-w-7xl mx-auto px-6 pb-16">
  <div class="reveal cta-band rounded-2xl p-8 md:p-10 relative overflow-hidden">
    ...
    <div class="relative flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
      <div>
        <p class="text-lime text-[12px] font-bold tracking-[0.12em] uppercase mb-2">Support Your Accounting Firm</p>
        <h3 class="font-display text-3xl md:text-4xl text-white leading-snug">Talk to Our Trusted<br/>Financial Advisors</h3>
        <p class="text-white/40 text-sm mt-2 max-w-md">Our dedicated team of financial advisors possesses a deep understanding of the accounting industry's financial requirements and challenges. We tailor funding solutions that align with your specific goals.</p>
      </div>
...
<div class="max-w-7xl mx-auto px-6 pb-16">
  <div class="reveal bg-[#0d0d0d] rounded-2xl p-8 md:p-10 border border-white/[0.07] max-w-4xl mx-auto text-center">
    ...
    <p class="text-[16px] text-white/50 font-light leading-[1.85] mb-4">
      Our dedicated team of financial advisors possesses a deep understanding of the accounting industry's financial requirements and challenges. We work closely with accounting firm owners to tailor funding solutions that align with their specific goals and financial situations. At BizCashAndCapital, we're committed to empowering accounting firms with the financial resources required to thrive and succeed in a competitive landscape.
    </p>
...
<footer class="bg-ink mt-6 border-t border-white/[0.07]">
  <div class="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
    <div class="md:col-span-2">
      ...
      <p class="text-white/45 text-[14px] font-light leading-relaxed max-w-[320px]">Tailored financing solutions for accounting firms — empowering you to enhance services, expand your client base, and fuel business growth.</p>
    </div>
    <div>
      ...
      <ul class="space-y-2 list-none">
        ...
        <li><a href="#" class="text-[14px] text-white/50 hover:text-lime transition-colors font-light">Technology Financing</a></li>
        <li><a href="#" class="text-[14px] text-white/50 hover:text-lime transition-colors font-light">Tax Season Loans</a></li>
        <li><a href="#" class="text-[14px] text-white/50 hover:text-lime transition-colors font-light">M&A Financing</a></li>
      </ul>
    </div>
    <div>
  ...
  <div class="border-t border-white/[0.07] px-6 py-5 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-2">
    ...
    <p class="text-[12px] text-white/18">Empowering Accounting Firms | CPA & Tax Professional Financing</p>
  </div>
</footer>

...
<title>Cleaning Business Funding | HarbourFundingSolutions — Tailored Financing for Cleaners</title>
<meta name="description" content="HarbourFundingSolutions provides specialized funding solutions for cleaning businesses — Lines of Credit, Equipment Financing, Merchant Cash Advances, and more. Grow your cleaning company.">
...
<section class="relative overflow-hidden min-h-[55vh] flex items-center justify-center pt-16">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-20 w-full text-center">
    <div class="inline-flex items-center gap-2 bg-white/5 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-white/10">
      ...
      <span class="text-[11px] font-medium tracking-[0.1em] uppercase text-white/70">Cleaning Industry Financing</span>
    </div>
    ...
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-lime/10 via-lime/5 to-transparent border border-lime/20 p-6 md:p-8 mt-6">
      ...
      <div class="flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
        <div>
          ...
          <h2 class="font-display text-2xl md:text-3xl font-bold text-white">The Importance of Funding for Cleaning Businesses</h2>
          <p class="text-white/60 text-sm mt-2 max-w-xl">Cleaning businesses ensure spaces remain hygienic and inviting. Securing adequate funding is vital for maintaining high-quality services, upgrading equipment, hiring skilled staff, and expanding your clientele.</p>
        </div>
...
<div id="funding-options" class="max-w-7xl mx-auto px-6 py-16">
  <div class="text-center mb-12 reveal">
    ...
    <h2 class="font-display text-4xl md:text-5xl text-white mb-3 lime-underline">Cleaning Business Funding Options</h2>
...
<div id="contact" class="max-w-7xl mx-auto px-6 pb-16">
  <div class="reveal cta-band rounded-2xl p-8 md:p-10 relative overflow-hidden">
    ...
    <div class="relative flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
      <div>
        <p class="text-lime text-[12px] font-bold tracking-[0.12em] uppercase mb-2">Support Your Cleaning Business</p>
        <h3 class="font-display text-3xl md:text-4xl text-white leading-snug">Talk to Our Trusted<br/>Financial Advisors</h3>
        <p class="text-white/40 text-sm mt-2 max-w-md">Our team of expert advisors understands the unique requirements and challenges of the cleaning industry. We tailor financing solutions that align with your specific goals.</p>
      </div>
...
<footer class="bg-ink mt-6 border-t border-white/[0.07]">
  <div class="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
    <div class="md:col-span-2">
      ...
      <p class="text-white/45 text-[14px] font-light leading-relaxed max-w-[320px]">Tailored financing solutions for cleaning businesses — empowering you to thrive and make the world a cleaner, healthier place.</p>
    </div>
    <div>
  ...
  <div class="border-t border-white/[0.07] px-6 py-5 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-2">
    ...
    <p class="text-[12px] text-white/18">Empowering Cleaning Businesses | Industry-Specific Financing</p>
  </div>
</footer>
